  ...
  return (
    <div
      ...
      className={`flex flex-col items-center justify-center gap-3 border-2 border-dashed rounded-xl px-8 py-16 cursor-pointer transition-colors ${
        dragging ? "border-[var(--foreground)] bg-blue-50" : "border-gray-300 bg-gray-50 hover:border-gray-400"
      }`}
    >
                  ...
                  <tr key={`${a.accountNo}|${a.division}`}>
                    ...
                    <td className="table-td text-right">
                      <button
                        ...
                        className="text-xs text-[var(--foreground)] hover:underline font-medium whitespace-nowrap"
                      >
                        + Add to category
                      </button>
                    </td>
      ...
      {reprocessing && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/20">
          <div className="bg-white rounded-xl shadow-lg px-8 py-5 flex items-center gap-3">
            <svg className="animate-spin w-5 h-5 text-[var(--foreground)]" viewBox="0 0 24 24" fill="none">
